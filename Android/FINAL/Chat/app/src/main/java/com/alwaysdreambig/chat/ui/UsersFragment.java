...
import com.alwaysdreambig.chat.core.GroupChatManagerImpl;
...
public class UsersFragment extends Fragment implements QBEntityCallback<ArrayList<QBUser>> {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        createChatButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                QBChatService qb = QBChatService.getInstance();
                Log.d("PROVA", qb.toString());
                QBGroupChatManager qbg = SplashActivity.groupChatManager;
                Log.d("PROVA", qbg.toString());

                //NPE called

                qbg.createDialog(dialogToCreate, new QBEntityCallbackImpl<QBDialog>() {
                        @Override
    ...
    public void onSuccess(ArrayList<QBUser> newUsers, Bundle bundle){
        ...
        for (QBUser user : newUsers) {
            if (!user.getLogin().equals(SplashActivity.USER_LOGIN))
            users.add(user);
        }


        //users.addAll(newerUsers);
