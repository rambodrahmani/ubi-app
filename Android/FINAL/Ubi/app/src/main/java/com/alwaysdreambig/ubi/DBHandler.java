...
public class DBHandler {
        ...
        public void get() {
            ...
            new HttpAsyncTask().execute("http://www.rambodrahmani.com/Ubi/android/request.php");
        }

        public void update() {
            new UpdateAsyncTask().execute("http://www.rambodrahmani.com/Ubi/android/update.php");
        }
