...
public class LoginActivity extends BarActivity implements
    ...
    public void FacebookLogin(View v) {
        ...
        if (isFacebookAvailable()) {
            ...
            WebSettings webSettings = mWebview.getSettings();  // mwebview restituisce null e poi clicca su okay mostra correttamente
    ...
    public void AccessoFacebook() {
        ...
        if (loginname != null) {
            ...
            new InsertMapAsyncTask().execute("http://alwaysdreambig.altervista.org/insertMappa.php");
