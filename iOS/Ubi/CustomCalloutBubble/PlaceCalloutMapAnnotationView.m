//
//  PlaceCalloutMapAnnotationView.m
//  Ubi
//
...
@interface PlaceCalloutMapAnnotationView()
...
@implementation PlaceCalloutMapAnnotationView
...
- (void)initProfilePicView:(UbiPlace *)newUbiPlace
{
	...
	[_profilePicView sd_setImageWithURL:newUbiPlace.place_icon_url
...
- (int)initLabels:(UbiPlace *)newUbiPlace :(CGSize)size
{
    int labelsWidth = 0;
    ...
    NSString * Nome = [[NSString alloc] initWithFormat:@"%@", newUbiPlace.place_name];
    ...
    NSString * Bio = [[NSString alloc] initWithFormat:@"%@", newUbiPlace.place_string];
    int bioMultiplier = 1;
    if (Bio.length > 30) {
        bioMultiplier = 2;
    }
    ...
    NSString * lastPost = [[NSString alloc] initWithFormat:@"%@", newUbiPlace.place_types];
...
- (void)initSocialLogo:(int)coordY :(NSString *)profileURL
{
    ...
    UIImage *Logo = [UIImage imageNamed:@"info.png"];
